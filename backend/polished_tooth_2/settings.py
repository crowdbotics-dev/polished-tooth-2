"""
Django settings for polished_tooth_2 project.
...
ROOT_URLCONF = 'polished_tooth_2.urls'
...
WSGI_APPLICATION = 'polished_tooth_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Polished Tooth Support <support@polished-tooth-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "polished_tooth_2 API",
    "DESCRIPTION": "API documentation for polished_tooth_2 App",
    "VERSION": "v1",
}
